    ...
    <form class="formulario" action="/user/create" method="post" enctype="multipart/form-data" id="form-create">
        ...
        <div class="row">
            <div class="col">
                ...
                <input minlength="14" maxlength="14" name="registro" type="text" class="form-control" style="background-color:#EEE9E9;" value="<?php echo getOld('registro'); ?>">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label name="escolapublic" class="form-check-label" for="nao">Não</label>
                </div>
                <?php echo getFlash('escolapublica'); ?>
            </div>

            <div class="col">
                <label for="formFileLg" class="form-label">Anexar comprovante de conclusão do ensino médio em escola pública (PFD/PNG/JPG)</label>
        ...
        <h3>Descreva sua experiência na cozinha</h3>

        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <label for="trabalhourestaurante" class="form-label">Já trabalhou em restaurantes? <span>*</span></label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="trabalhourestaurante" style="background-color:#EEE9E9;"></textarea>
                    <?php echo getFlash('trabalhourestaurante'); ?>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
            <button class="btn btn-info text-light" type="submit">Clique aqui e faça sua inscrição</button>
